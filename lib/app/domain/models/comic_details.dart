...
//
//     final comicDetails = comicDetailsFromJson(jsonString);

import 'dart:convert';

ComicDetailsResult comicDetailsFromJson(String str) =>
    ComicDetailsResult.fromJson(json.decode(str));

String comicDetailsToJson(ComicDetailsResult data) =>
    json.encode(data.toJson());

class ComicDetailsResult {
  ComicDetailsResult({
    this.error,
    this.limit,
    this.offset,
  ...
  int? statusCode;
  ComicDetails? results;
  String? version;

  factory ComicDetailsResult.fromJson(Map<String, dynamic> json) =>
      ComicDetailsResult(
        error: json["error"],
        limit: json["limit"],
        offset: json["offset"],
        ...
        results: ComicDetails.fromJson(json["results"]),
